...
const Services = () => {
    return (
        <div className='text-center p-4 max-w-[1100px] mx-auto'>
            <h1 className='text-4xl text-white font-bold uppercase'>Services</h1>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-8 lg:p-16  text-start'>
                <div className="card  blue-shadow-box bg-base-100 ">
                    <div className="card-body">
                        <div className="avatar">
                            <div className="w-8 bg-white p-2 rounded">
                        ...
                        <div>
                            ...
                            <label htmlFor="my-modal-1" className="text-warning">view more ➔</label>
                            ...
                            <div className="modal ">
                                <div className="modal-box relative p-10 rounded">
                                    ...
                                    <div className='text-center  lg:mt-10'><h3 className="text-2xl font-bold">Web Developer</h3>
                                        <p className="py-4 ">In basic terms, I'm responsible for contributing to building and maintaining websites that are resilient and functional</p></div>
                ...
                <div className="card   blue-shadow-box bg-base-100 bg-base-100 ">
                    <div className="card-body">
                        <div className="avatar">
                            <div className="w-8 bg-white p-2 rounded">
                        ...
                        <div>
                            ...
                            {/* The button to open modal */}
                            <label htmlFor="my-modal-2" className="text-warning">view more ➔</label>
                            ...
                            <div className="modal ">
                                <div className="modal-box relative p-10 rounded">
                                    ...
                                    <div className='text-center mt-10'><h3 className="text-2xl text-gray-700 font-bold">UI/UX Designer</h3>
                                        <p className="py-4 ">In basic terms, I'm responsible for collecting and translating user insights into delightful experiences.</p></div>
                ...
                <div className="card  blue-shadow-box bg-base-100 bg-base-100 ">
                    <div className="card-body">
                        ...
                        <div>
                            ...
                            {/* The button to open modal */}
                            <label htmlFor="my-modal-3" className="text-warning">view more ➔</label>
                            ...
                            <div className="modal ">
                                <div className="modal-box relative p-10 rounded">
                                    ...
                                    <div className='text-center mt-10'><h3 className="text-2xl text-gray-700 font-bold">Authentication</h3>
                                        <p className="py-4 ">As a web developer, I authenticate the browser or application as a requirement.</p></div>
                ...
                <div  className="card  blue-shadow-box bg-base-100  bg-base-100 ">
                    <div className="card-body">
                        ...
                        <h2 className="text-2xl font-bold ">Error Solving</h2>
                        <div>

                            {/* The button to open modal */}
                            <label htmlFor="my-modal-4" className="text-warning">view more ➔</label>
                            ...
                            <div className="modal ">
                                <div className="modal-box relative p-10 rounded">
                                    ...
                                    <div className='text-center mt-10'><h3 className="text-2xl text-gray-700 font-bold">Error Solving</h3>
                                        <p className="py-4 ">My goal as a developer is to solve problems. It might be a new feature, fixing a bug or research new technologies and approaches.</p></div>
